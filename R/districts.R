...
#'
#' @md
#' @param state_id a length 1 character vector with a state ID
...
#' @return data frame
#' @export
ial_districts <- function(state_id, interval_start, interval_stop) {
  ...
  url_template <- "http://api.nightlights.io/months/%s-%s/state/%s/districts"
